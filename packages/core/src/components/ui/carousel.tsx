...
function CarouselContent({ className, ...props }: React.ComponentProps<"div">) {
  ...
  return (
    <div
      ref={carouselRef}
      className="luth-overflow-hidden"
...
function CarouselPrevious({
  ...
  return (
    <Button
      ...
      size={size}
      className={cn(
        "luth-absolute luth-size-8 luth-rounded-full",
        orientation === "horizontal"
          ? "luth-top-1/2 luth--left-12 luth--translate-y-1/2"
  ...
  return (
    <Button
      ...
      className={cn(
        "luth-absolute luth-size-8 luth-rounded-full",
        orientation === "horizontal"
          ? "luth-top-1/2 luth--right-12 luth--translate-y-1/2"
