...
Command: npx gltfjsx@6.5.2 ./public/luth.glb --types --transform --keepnames --keepmeshes --draco --meta --shadows --exportdefault --instanceall --output ./src/_generated/LuthAcoustic.tsx 
Files: ./public/luth.glb [1.72MB] > /Users/samsoedien/Documents/Repositories/project-luth/apps/common/src/_generated/luth-transformed.glb [926.08KB] (46%)
*/
...
export type GLTFResult = GLTF & {
  nodes: {
    ...
    ['Body_Back_3Piece_Venetian_Cutaway_Middle_(1)']: THREE.Mesh
    ['Body_Back_3Piece_Florentine_Cutaway_Middle_(1)']: THREE.Mesh
  ...
  materials: {
    ['Mahogany Wood Satin #1']: THREE.MeshStandardMaterial
    ['Mahogany Wood Satin #1']: THREE.MeshStandardMaterial
    ['Mahogany Wood Satin #1']: THREE.MeshStandardMaterial
    ['Mahogany Wood Satin #1']: THREE.MeshStandardMaterial
    ['Mahogany Wood Satin #1']: THREE.MeshStandardMaterial
...
export function Instances({ children, ...props }: JSX.IntrinsicElements['group']) {
  ...
  const instances = React.useMemo(
    () => ({
      ...
      BodyBackPieceVenetianCutawayMiddle: nodes['Body_Back_3Piece_Venetian_Cutaway_Middle_(1)'],
  ...
  return (
    <group {...props} dispose={null}>
      <PerspectiveCamera
        ...
        near={3606.229}
        fov={14.345}
        position={[3.328, -0.381, 1.873]}
        rotation={[0.281, 1.029, -0.243]}
        scale={0.001}
      ...
      />
      <instances.SurfaceBack
        name="Surface_Back"
        scale={0.001}
        userData={{ name: 'Surface_Back' }}
      />
      ...
      <instances.BodyBackPieceVenetianCutawayMiddle
        name="Body_Back_3Piece_Venetian_Cutaway_Middle_(1)"
        scale={0.001}
        userData={{ name: 'Body_Back_3Piece_Venetian_Cutaway_Middle (1)' }}
      />
      <instances.BodyBackPieceVenetianCutawayMiddle
        name="Body_Back_3Piece_Florentine_Cutaway_Middle_(1)"
        scale={0.001}
        userData={{ name: 'Body_Back_3Piece_Florentine_Cutaway_Middle (1)' }}
      />
